...
struct bt_params_t {
    bt_bool_t authenticate; /** ';authenticate=' parameter. */
    bt_bool_t authorize; /** ';authorize=' parameter. */
    bt_bool_t encrypt; /** ';encrypt=' parameter. */
    bt_bool_t master; /** ';master=' parameter. */
...
struct bt_client_t {
    bt_handle_t handle; /**< Client connection handle. */
    bt_bdaddr_t bdaddr; /**< Client Bluetooth address. */
    int rmtu; /**< Receive MTU. */
    int tmtu; /**< Transmit MTU. */
...
struct bt_push_t {
    ...
    bt_handle_t server; /**< Server connection handle. */
 ...
 *
 * @return BT_RESULT_SUCCESS if successful, BT_RESULT_FAILURE otherwise
 */
 ...
 * @return BT_BOOL_TRUE if the parameter is Bluetooth URL,
 ...
 * @return BT_BOOL_TRUE if the comparison succeeds, BT_BOOL_FALSE otherwise
 */
 ...
 * @return BT_BOOL_TRUE if the connection was accepted, BT_BOOL_FALSE otherwise
 */
 ...
 * @return BT_RESULT_SUCCESS on success, BT_RESULT_FAILURE on failure or
