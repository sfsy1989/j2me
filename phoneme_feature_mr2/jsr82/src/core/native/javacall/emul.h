...
// Need revisit use constants.xml instead. 
...
typedef struct _connection_info_t {
    ...
    javacall_bool is_connecting;
	javacall_bool is_sending;
	javacall_bool is_receiving;
...
typedef struct _emul_data_t {
    ...
    javacall_bt_address local_addr;
