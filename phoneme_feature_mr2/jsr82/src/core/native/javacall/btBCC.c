 ...
 */
javacall_result javacall_bt_bcc_initialize()
{
    return JAVACALL_OK;
}
 ...
 * @retval JAVACALL_FAIL if an error occurred
 */
javacall_result javacall_bt_bcc_finalize()
{
    return JAVACALL_OK;
}
 ...
 */
javacall_result javacall_bt_bcc_confirm_enable(javacall_bool *retval)
{
 ...
 */
javacall_result javacall_bt_bcc_is_connectable(javacall_bool *retval)
{
    *retval = JAVACALL_TRUE;
    return JAVACALL_OK;
}
 ...
 * @retval JAVACALL_FAIL on failure
 */
javacall_result javacall_bt_bcc_is_paired(const javacall_bt_address bdaddr, javacall_bool *retval)
{
    (void)bdaddr;
 ...
 */
javacall_result javacall_bt_bcc_put_passkey(const javacall_bt_address bdaddr, bt_string_t pin,
        javacall_bool ask)
{
    (void)bdaddr;
    (void)ask;
 ...
 * @retval JAVACALL_FAIL if an error occurred
 */
javacall_result javacall_bt_bcc_authorize(const javacall_bt_address bdaddr, 
 ...
 * @retval JAVACALL_FAIL on failure
 */
javacall_result javacall_bt_bcc_get_preknown_devices(javacall_bt_address devices[],
        int *pCount)
{
    (void)devices;
    *pCount = 0;
