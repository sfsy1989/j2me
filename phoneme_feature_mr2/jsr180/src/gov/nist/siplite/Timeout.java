 ...
 * <ul>
 * <li> {@link Timeout#RETRANSMIT} - This type is used to alert an
 * application that
 ...
 * per transaction using {@link Transaction#enableRetransmissionTimer(int)}. The
 ...
 * <li><b>User Agent with No Retransmission</b> - an application can
 * configure an
 ...
 * <li><b>Stateful Proxy</b> - a stateful proxy remembers transaction
 * state about
 ...
 * not retransmit
 * messages, therefore an application will not receive {@link
 * Timeout#RETRANSMIT}
 ...
 * of {@link Timeout#TRANSACTION} events on any of its
