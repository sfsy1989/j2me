        ...
        do {
            ...
            if (trySend) {
                ...
                if (status == WMA_ERR) {
                    ...
                    /*
                     * Notify the platform-specific code that the send has completed.
                     * This allows the native platform to execute any special code.
                     */
                    jsr205_mms_notify_send_completed(&bytesSent);
                }
            }
        } while (0);
        ...
        do {
            ...
            if (pMmsData != NULL) {
                ...
                if ((pMmsData = jsr205_mms_pool_retrieve_next_msg(appID)) != NULL) {
                    ...
                    /*
                     * A message has been retrieved successfully. Notify the platform.
                     */
                    jsr205_notify_incoming_mms(pMmsData);
