...
PlatformMIDPMainWindow::PlatformMIDPMainWindow(QWidget *parent, 
  ...
  //mscreen->setBackgroundColor( Qt::white );
  //cmd->setBackgroundColor( Qt::white );
//edit by sookie
  setCentralWidget(mwindow);
  //setGeometry(mwindow->x()+100, mwindow->y()+100,mwindow->width(),mwindow->height());
