...
/**
 * Converts the given <code>kjobject</code> to a pointer of the given
 * type.
 */
#define unhand(__type, __ptr)  (*((__type**)(void*)(__ptr)))

/**
 * Converts the given pointer to a <code>kjobject</code>.
 */
#define hand(__ptr)  (((kjobject)(void*)&(__ptr)))

/* Macros to handle primitive array types */
/**
 * Converts the given <code>kjobject</code> to array of <tt>jbyte</tt>.
...
/**
 * Converts the given <code>kjobject</code> to array of <tt>jchar</tt>.
 * Such a spophisticated furmula is used to prevent erros issuing by 
 * some smart compilers that can otherwise track number of elements 
...
/**
 * Converts the given <code>kjobject</code> to array of <tt>jshort</tt>.
 * Such a spophisticated furmula is used to prevent erros issuing by 
 * some smart compilers that can otherwise track number of elements 
...
/**
 * Converts the given <code>kjobject</code> to array of <tt>jint</tt>.
 * Such a spophisticated furmula is used to prevent erros issuing by 
 * some smart compilers that can otherwise track number of elements 
