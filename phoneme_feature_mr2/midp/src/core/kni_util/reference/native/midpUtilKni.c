...
int      scratchInt1;
int      scratchInt2;
kjobject  scratchObject1;
kjobject  scratchObject2;
kjobject *scratchHandle1 = &scratchObject1;
kjobject *scratchHandle2 = &scratchObject2;
 ...
 */
jfieldID
midp_get_field_id(KNIDECLARGS kjclass classHandle,
                  const char* name,
 ...
 */
jfieldID
midp_get_static_field_id(KNIDECLARGS kjclass classHandle,
                         const char* name,
                         const char* signature)
{
...
pcsl_string_status midp_get_string_field(KNIDECLARGS kjobject obj, kjclass classObj,
    ...
    return midp_kjstring_to_pcsl_string(fieldHandle, result);
}


/**
 * Set a kjobject field from Java native functions.
 *
 ...
 */
MidpString midpNewStringImpl(kjstring jStringHandle, char* filename,
       int line) {
    MidpString result;
 ...
 * @return status of the operation
 */
pcsl_string_status midp_kjstring_from_pcsl_string(KNIDECLARGS
