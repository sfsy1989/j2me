 ...
 */
static void
cacheEventFieldIDs(KNIDECLARGS kjobject eventObj, kjclass classObj) {
    (void) _arguments;
    (void) _p_mb;
...
static void getControlStringField(KNIDECLARGS kjobject objectHandle,
...
static void setControlStringField(KNIDECLARGS kjobject objectHandle,
                                   kjobject stringObj, jfieldID fieldID, pcsl_string *str) {
...
static const char*  getEventName(KNIDECLARGS kjobject objectHandle, jfieldID fieldID)
{
