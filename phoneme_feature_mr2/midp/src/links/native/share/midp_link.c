 ...
 */
static void
getReference(int refId, char *msg, kjobject obj)
{
...
static void
setNativePointer(kjobject linkObj, rendezvous *rp)
{
...
static rendezvous *
getNativePointer(kjobject linkObj)
{
    rendezvous *rp;
    jfieldID nativePointerField;
...
static void
getContents(kjobject linkMessageObj, kjobject contentsObj)
{
...
static void
setContents(kjobject linkMessageObj, kjobject contentsObj)
{
    jfieldID contentsField;
...
static void
getRange(kjobject linkMessageObj, int *offset, int *length)
{
...
static void
setRange(kjobject linkMessageObj, int offset, int length)
{
    jfieldID offsetField;
    jfieldID lengthField;
 ...
 */
static jboolean
copy(kjobject fromMsg, kjobject toMsg, kjobject toLink) {
    jboolean retval;
