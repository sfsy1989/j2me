...
primDrawHorzLine(gxj_screen_buffer *sbuf, gxj_pixel_type color,
  ...
  int count;
  gxj_pixel_type* pPtr;
  unsigned int c = (sizeof(gxj_pixel_type) == 4) ? color : 
                   ((unsigned int)color) << 16 | ((unsigned int)color);
