...
/** GIF file header  */
extern const unsigned char gxutl_gif_header[3];
...
/** GIF image buffer layout */
typedef struct {
    unsigned char header[6];  /**< Must equal gxutl_gif_header */
	unsigned char unused[4];  /**< never used in the code */
	unsigned char data[1];    /**< variable length byte array */
} gxutl_image_buffer_gif;
