...
gxpport_create_mutable(gxpport_mutableimage_native_handle *newImagePtr,
			   ...
			   REPORT_INFO(LC_LOWUI, "gxpportqt_mutableimage:gxpport_create_mutable\n");
   ...
   */  
   #ifdef FV_USE_QT4
     QPixmap* qpixmap = new QPixmap(width, height); /* Start with a NULL image object */
   #else
...
gxpport_render_mutableimage(gxpport_mutableimage_native_handle srcImagePtr,
				...
				REPORT_INFO(LC_LOWUI, "gxpportqt_mutableimage:gxpport_render_mutableimage\n");
...
gxpport_render_mutableregion(gxpport_mutableimage_native_handle srcImagePtr,
				 ...
				 REPORT_INFO(LC_LOWUI, "gxpportqt_mutableimage:gxpport_render_mutableregion\n");
    QPixmap *qpixmapDst = (QPixmap *)(dstImagePtr);
...
gxpport_destroy_mutable(gxpport_mutableimage_native_handle imagePtr) {
	...
	REPORT_INFO(LC_LOWUI, "gxpportqt_mutableimage:gxpport_destroy_mutable\n");
...
gxpport_get_mutable_argb(
 ...
 gxutl_native_image_error_codes* errorPtr) {
	...
	REPORT_INFO(LC_LOWUI, "gxpportqt_mutableimage:gxpport_get_mutable_argb\n");
...
(gxpport_mutableimage_native_handle mutableImagePtr) {
	...
	REPORT_INFO(LC_LOWUI, "gxpportqt_mutableimage:gxpportqt_get_mutableimage_pixmap\n");
