...
find_font(int face, int style, int size) {
	REPORT_INFO(LC_LOWUI, "gxpportqt_text:find_font\n");
...
make_string(const jchar *charArray, int len) {
	REPORT_INFO(LC_LOWUI, "gxpportqt_text:make_string\n");
...
gxpport_get_fontinfo(int face, int style, int size, 
			 ...
			 REPORT_INFO(LC_LOWUI, "gxpportqt_text:gxpport_get_fontinfo\n");
...
gxpport_get_charswidth(int face, int style, int size, 
			   ...
			   REPORT_INFO(LC_LOWUI, "gxpportqt_text:gxpport_get_charswidth\n");
