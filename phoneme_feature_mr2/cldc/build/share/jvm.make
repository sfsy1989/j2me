...
ROM_GEN_ARG         += $(ROM_GEN_FLAGS) =HeapCapacity128M
...
ifeq ($(PCSL_PLATFORM),linux_mips_gcc)
PCSL_DIST_DIR = $(PCSL_OUTPUT_DIR)/$(os_family)_mips
else
...
ifeq ($(PCSL_PLATFORM),linux_mips_gcc)
 CPP_gcc           = $(GCC_PREFIX)g++$(GCC_POSTFIX) -EL
 CC_gcc            = $(GCC_PREFIX)gcc$(GCC_POSTFIX) -EL
 LINK_gcc          = $(GCC_PREFIX)g++$(GCC_POSTFIX) -EL
else
...
ASM_FLAGS += -mfpu=vfp -mfloat-abi=softfp
endif
