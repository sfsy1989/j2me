...
class UTF8Stream : public CharacterStream {
 ...
 public:
#if 0
  UTF8Stream::UTF8Stream(jint utf8_start, jint utf8_length) : CharacterStream() { 
    _utf8_start  = utf8_start;
    _utf8_length = utf8_length;
    reset();
  }
#endif
  UTF8Stream(jint utf8_start, jint utf8_length);
...
#if 0
  UnicodeStream::UnicodeStream(jint unicode_start, jint unicode_length) : CharacterStream() { 
    _unicode_start  = unicode_start;
    _unicode_length = unicode_length;
    reset();
  }
#endif
  UnicodeStream(jint unicode_start, jint unicode_length);
...
class ConcatenatedStream : public CharacterStream {
 public:
#if 0
  ConcatenatedStream::ConcatenatedStream(CharacterStream* stream1, CharacterStream* stream2)
      : CharacterStream() {
    _stream1 = stream1;
    _stream2 = stream2;
