...
KNIEXPORT void KNI_GetSuperClass(kjclass classHandle, kjclass superclassHandle) {
...
// Object operations
//
KNIEXPORT void KNI_GetObjectClass(kjobject objectHandle, kjclass classHandle) {
...
//
jfieldID _KNI_field_lookup_helper(kjclass classHandle, const char* name,
...
KNIEXPORT void
KNI_GetObjectField(kjobject objectHandle, jfieldID fieldID, kjobject toHandle) {
  OopDesc* object = kni_read_handle(objectHandle);
...
KNIEXPORT void
KNI_SetObjectField(kjobject objectHandle, jfieldID fieldID, kjobject fromHandle)
{
  OopDesc* object = kni_read_handle(objectHandle);
...
KNIEXPORT void KNI_GetStringRegion(kjstring stringHandle, jsize offset, jsize n,
                                   jchar* jcharbuf) {
  String::Raw string = kni_read_handle(stringHandle);
...
KNIEXPORT void KNI_NewString(const jchar* src, jsize n, kjstring stringHandle) {
  SETUP_ERROR_CHECKER_ARG;
  UsingFastOops fast_oops;
...
KNIEXPORT void KNI_NewStringUTF(const char* utf8chars, kjstring stringHandle) {
  SETUP_ERROR_CHECKER_ARG;
  kni_clear_handle(stringHandle); // just in case of OutOfMemory
...
// Array operations
//
KNIEXPORT jsize KNI_GetArrayLength(kjarray arrayHandle) {
  Array::Raw a = kni_read_handle(arrayHandle);
  return (jsize)a.is_null() ? -1 : a().length();
}

KNIEXPORT jboolean
KNI_GetBooleanArrayElement(kjbooleanArray arrayHandle, jsize index) {
...
KNIEXPORT jbyte
KNI_GetByteArrayElement(kjbyteArray arrayHandle, jsize index) {
  TypeArray::Raw type_array = kni_read_handle(arrayHandle);
...
KNIEXPORT jchar
KNI_GetCharArrayElement(kjcharArray arrayHandle, jsize index) {
  TypeArray::Raw type_array = kni_read_handle(arrayHandle);
...
KNIEXPORT jshort
KNI_GetShortArrayElement(kjshortArray arrayHandle, jsize index) {
  TypeArray::Raw type_array = kni_read_handle(arrayHandle);
...
KNIEXPORT jint
KNI_GetIntArrayElement(kjintArray arrayHandle, jsize index) {
  TypeArray::Raw type_array = kni_read_handle(arrayHandle);
...
KNIEXPORT jlong
KNI_GetLongArrayElement(kjlongArray arrayHandle, jsize index) {
  TypeArray::Raw type_array = kni_read_handle(arrayHandle);
...
KNIEXPORT jfloat
KNI_GetFloatArrayElement(kjfloatArray arrayHandle, jsize index) {
  TypeArray::Raw type_array = kni_read_handle(arrayHandle);
...
KNIEXPORT jdouble
KNI_GetDoubleArrayElement(kjdoubleArray arrayHandle, jsize index) {
  TypeArray::Raw type_array = kni_read_handle(arrayHandle);
...
KNIEXPORT void
KNI_SetByteArrayElement(kjbyteArray arrayHandle, jsize index, jbyte value) {
  TypeArray::Raw type_array = kni_read_handle(arrayHandle);
...
KNIEXPORT void
KNI_SetCharArrayElement(kjcharArray arrayHandle, jsize index, jchar value) {
  TypeArray::Raw type_array = kni_read_handle(arrayHandle);
...
KNIEXPORT void
KNI_SetShortArrayElement(kjshortArray arrayHandle, jsize index, jshort value) {
  TypeArray::Raw type_array = kni_read_handle(arrayHandle);
...
KNIEXPORT void
KNI_SetIntArrayElement(kjintArray arrayHandle, jsize index, jint value) {
  TypeArray::Raw type_array = kni_read_handle(arrayHandle);
...
KNIEXPORT void
KNI_SetLongArrayElement(kjlongArray arrayHandle, jsize index, jlong value) {
  TypeArray::Raw type_array = kni_read_handle(arrayHandle);
...
KNIEXPORT void
KNI_SetFloatArrayElement(kjfloatArray arrayHandle, jsize index, jfloat value) {
  TypeArray::Raw type_array = kni_read_handle(arrayHandle);
...
static inline address _KNI_GetRawArrayRegion_start_address(kjarray src,
                                                           jsize offset) {
...
KNIEXPORT void KNI_GetParameterAsObject(jint index, kjobject obj) {
  GUARANTEE(!_in_kvm_native_method, "sanity");
...
KNIEXPORT int _KNI_push_handles(int n, _KNI_HandleInfo* info, kjobject* handles)
{
  ...
  jvm_memset(handles, 0, n * sizeof(kjobject));
