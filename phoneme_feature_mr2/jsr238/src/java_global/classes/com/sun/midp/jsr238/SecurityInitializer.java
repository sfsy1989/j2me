 ...
 * JSR 238 implemenation classes. Modify this class instead of
 * com.sun.midp.security.SecurityInitializer each time another
 * JSR 238 implementation class requires initializing security token.
 */
public final class SecurityInitializer {

    /** List of trusted class names for JSR 238 */
    final static private String[] trustedClasses = new String[] {
        "com.sun.j2me.global.DevResourceBundleReader$SecurityTrusted",
        "com.sun.j2me.global.DevResourceManagerFactory$SecurityTrusted",
        "com.sun.j2me.global.NormalizationTableImpl$SecurityTrusted",
        "com.sun.j2me.global.CollationElementTableImpl$SecurityTrusted"
    };
