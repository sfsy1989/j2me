 ...
 * <code>com.sun.j2me.global</code> package to the emulator needs. It is assumed
 * that it will be modified or rewritten to be more optimized for a target
 * device.
 *
 */
public class ResourceAbstractionLayerImpl extends ResourceAbstractionLayer {
    ...
    /**
     * Create instance of <code>ResourceAbstractionLayer</code>. This
     ...
     *
     * @return    device resource manager
     */
     ...
     *
     * @return    application resource manager
     */
