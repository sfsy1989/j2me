...
public abstract class CollationAbstractionLayer {
     ...
     * in individual implementation. If no locales are supported, the returned
     * array must be empty, not <code>null</code>. As the value
     * <code>null</code> is not technically a valid locale, but a special value
     * to trigger the generic collation algorithm, it must not appear in the
     * array.
     *
